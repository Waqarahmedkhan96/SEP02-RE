...
public interface BookingDAO {
    ...
    List<Booking> findByVehicleId(int vehicleId) throws SQLException;
    List<Booking> findByVehicleIdExcludingBooking(int vehicleId, int excludedBookingId) throws SQLException;
